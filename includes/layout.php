...
function layout_header(string $title, string $active = ''): void
{
    $nav = [
        ...
        'leads'     => ['leadfinder.php','Lead Finder','M4 19v-7m6 7V5m6 14v-9m4-5l-7 7-4-4-5 5'],
        'maps'      => ['maps.php',      'Google Maps','M12 21s7-6.2 7-12a7 7 0 10-14 0c0 5.8 7 12 7 12zm0-9a3 3 0 100-6 3 3 0 000 6'],
        'inbox'     => ['inbox.php',     'Replies Inbox','M3 6h18v12H3zM3 7l9 6 9-6M8 13h8'],
